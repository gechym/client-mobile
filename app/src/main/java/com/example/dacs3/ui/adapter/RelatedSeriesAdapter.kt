...
import com.example.dacs3.data.retrofit.module.getDetail.RelatedSeries
...
class RelatedSeriesAdapter(
    private val list: List<RelatedSeries>,
    private val context: Context,
    private val root : ConstraintLayout
) : RecyclerView.Adapter<RelatedSeriesAdapter.viewHolder>() {
